...
from DataArray import activity_list, actor_list

id_activityName_entity="1049592985455296"
id_actorEmail_entity="314511973098263"
...
'''''
driver.get(entities_url+"/"+id_activityName_entity)
for activity in activity_list:
    ...
    keyword_area.clear()
    keyword_area.send_keys(activity)
